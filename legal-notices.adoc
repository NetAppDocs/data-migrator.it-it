...
summary: Note legali, copyright, marchi registrati e informazioni sulla licenza open source di NetApp Data Migrator. 
---
= Note legali
:allow-uri-read: 
:icons: font
...
link:./media/data_migraotor_notice_2026.04.0_GA.pdf["Avviso per NetApp Data Migrator"^]
